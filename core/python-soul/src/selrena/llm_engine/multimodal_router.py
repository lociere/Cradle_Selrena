...
class MultimodalRouter:
    ...
    def _run_specialist(
        ...
        from selrena.llm_engine.llm_engine import LLMMessage, LLMRequest
        ...
        for idx, img in enumerate(image_items, 1):
            ...
            try:
                ...
                fallback = semantic_text or f"无法识别的{label}"
        ...
        for idx, vid in enumerate(video_items, 1):
            ...
            try:
                ...
                fallback = semantic_text or "无法识别的视频"
